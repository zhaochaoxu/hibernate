...
<head>
    ...
    <title>红太阳CRM | 客户信息 | ${customer.name}</title>
                ...
                <div class="box-body">
                    <table class="table">
                        <tr>
                            ...
                            <td style="width: 80px">${customer.tel}</td>
                            <td style="width: 80px">邮箱：</td>
                            <td style="width: 80px">${customer.email}</td>
                            <td style="width: 80px">微信：</td>
                            <td style="width: 80px">${customer.weixin}</td>
                        </tr>
                        <tr>
                            <td>等级:</td>
