...
<div class="wrapper">
    ...
    <jsp:include page="../include/left.jsp">
        <jsp:param name="menu" value="task"></jsp:param>
    </jsp:include>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            <ul class="todo-list">
                                <c:forEach items="${outTask}" var="task">
                                    <li>
                                        <input type="checkbox">
                                        <span class="text">${task.title}</span>
                                        <div class="tools">
                                            <i rel="${task.id}" class=" delOutTask fa fa-trash-o"></i>
                                        </div>
                                    </li>
                                </c:forEach>
                            </ul>
...
<script>
    $(function () {
        ...
        $("#saveBtn").click(function () {
            ...
            if (moment($("#startTime").val()).isAfter(moment($("#endTime").val()))) {
                alert("结束时间必须大于开始时间");
                return;
            }
        ...
        $(document).delegate(".delOutTask", "click", function () {
